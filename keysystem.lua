-- [[ st4r HUB - UNIVERSAL SECURE KEY SYSTEM ]]
-- Developer: Wissam
...
local Config = {
    ...
    ServiceId       = 23962, -- Your PlatoBoost Service ID
    PlatoSecret     = "5fb63a2d-84ba-4246-abe6-136a99de281c", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "srtst4r", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    ...
    -- [6] GUI Management
    OldGuiName      = "st4r hub", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "st4r hub", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "st4r hub", -- The main title shown at the top of the GUI
    HubDescription  = "my own script for cheating" -- The text shown below the title
}
